...
int main() {
	...
	//Ожидалось, что с dynamic_cast будете работать с виртуальными классами и 
	//сделаете неуспешное преобразование, которое вернет указатель nullptr и bad_cast в случае ссылки. 
